...
Record a workflow you perform manually in the browser as jsonl events an agent can turn
...
playwriter recorder stop                  # stop and print event count + jsonl path
playwriter recorder events                # thin event timeline of the latest recording
playwriter recorder events 1 4 7          # full details of events 4 and 7 in recording 1
playwriter recorder status                # list active recordings
```
